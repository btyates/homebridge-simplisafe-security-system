...
## Notes
- The "night" toggle in the iOS 12 Home App UI sets the alarm state to "home" in SimpliSafe. This is due to SimpliSafe not having a dedicated "night" mode.
- Usage of this plugin requires the SimpliSafe Interactive Monitoring plan ($24.99), since that enables the required API endpoints to control the alarm remotely.
